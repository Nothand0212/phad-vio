...
- CMake 项目骨架和测试框架；
- timestamp、IMU measurement、bias 和 calibration 类型；
- IMU 输入校验；
...
## 阶段 2：纯双目 batch bundle adjustment
...
## 阶段 3：batch stereo VIO

范围：

- 合并阶段 1 的 \(X/V/B\) 状态与阶段 2 的 stereo factors；
- 5 至 10 个关键帧；
